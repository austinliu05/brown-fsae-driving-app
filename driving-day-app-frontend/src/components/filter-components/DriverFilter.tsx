...
export default function DriverFilter({
    ...
    return (
        <select onChange={(event) => setDriverOption(event.target.value)} className="w-full px-4 py-2 border border-gray-200 rounded-md bg-white min-w-0 sm:min-w-[200px] sm:w-auto focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent">
