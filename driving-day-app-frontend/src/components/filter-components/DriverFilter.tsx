...
export default function DriverFilter({
    ...
    return (
        <select onChange={(event) => setDriverOption(event.target.value)} className="px-3 md:px-4 py-2 border border-gray-200 rounded-md bg-white w-full md:min-w-[200px] text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent">
